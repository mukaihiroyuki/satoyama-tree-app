                                ...
                                >
                                    ...
                                    {species.map((s) => (
                                        <option key={s.id} value={s.id}>
                                            {s.name === 'アオハダ' ? '★ アオハダ（アオダモと間違えやすい）' : s.name}
                                        </option>
                                    ))}
                                </select>
                                {selectedSpecies_ && (
                                    <div className="mt-2 bg-green-50 border-2 border-green-300 rounded-xl px-4 py-3 text-center">
                                        <p className="text-2xl font-black text-green-800">{selectedSpecies_.name}</p>
                                        <p className="text-xs text-green-600 mt-1">この樹種で合っていますか？</p>
                                    </div>
                                )}
                            </>
                        )}
