...
const styles = StyleSheet.create({
    ...
    colManagement: { flex: 1, paddingHorizontal: 6 },
    colHeight: { width: 50, textAlign: "right", paddingHorizontal: 6 },
    colUnitPrice: { width: 90, textAlign: "right", paddingHorizontal: 6 },
    headerText: {
        fontSize: 7,
        fontWeight: "bold",
        color: "#475569",
